...
exports.update = function(params, callback) {
    var query = 'UPDATE account SET account_id = ?, email = ?, first_name = ?, last_name = ? WHERE email = ?';
    var queryData = [params.account_id, params.first_name, params.last_name, params.email];
